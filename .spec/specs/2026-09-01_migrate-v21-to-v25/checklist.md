...
## 行为成效
- [x] 统一门禁结果：`pnpm run check` 通过，2026-09-01 为 181 个测试文件、1332 个测试、35 个 Turbo task 成功（此前基线 1301）
