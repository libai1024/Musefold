...
- [ ] 完成设计方案全链路迁移与 v2.1 功能 parity
  ...
  - verify: v2.1 设计方案导航、列表/详情、创建/编辑/复制/删除、AI 生成/运行、版本与工作台联动按历史实现逐项验证；Web 与 Electron E2E、contracts/repository/API/IPC/features tests 通过。当前仅本地持久化、确定性 adapter、固定计划校验、取消和 `.musefold.design` 安全 staging/archive 已接线；共享 UI、Web runtime、云端 run/assets/package、Desktop Agent event 和真实成功 E2E 尚未闭合
