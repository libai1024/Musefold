...
const controller = readFileSync('apps/desktop/electron/main/pet/index.ts', 'utf8');
const windowSource = readFileSync('apps/desktop/electron/main/pet/window.ts', 'utf8');
const renderer = readFileSync('apps/desktop/src/pet/PetApp.tsx', 'utf8');
