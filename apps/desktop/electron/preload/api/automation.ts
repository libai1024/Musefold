...
export const automationApi = {
  ...
  onConfirmationRequired: (
    cb: (summary: import('@musefold/desktop-contracts/ipc').AutomationConfirmationSummary) => void,
  ) => {
    const listener = (
      _event: unknown,
  ...
  integrationAction: (action: import('@musefold/desktop-contracts/ipc').IntegrationAction) =>
