...
export const aiConnectionApi = {
  ...
  update: (id: string, patch: import('@musefold/desktop-contracts/ai').UpdateAiConnectionInput) =>
...
export const providerApi = {
  ...
  saveKey: (id: string, apiKey: string) => ipcRenderer.invoke(IPC.PROVIDER_SAVE_KEY, id, apiKey),
  ...
  onWebLoginChanged: (
    cb: (status: import('@musefold/desktop-contracts/providers').DoubaoWebAccountStatus) => void,
  ) => {
    const listener = (
      _event: unknown,
...
export const imageApi = {
  ...
  stageLocal: (input: import('@musefold/desktop-contracts/providers').StageLocalImageInput) =>
  ...
  onProgress: (
    cb: (progress: import('@musefold/desktop-contracts/providers').ImageGenerationProgress) => void,
  ) => {
    const listener = (
      _event: unknown,
