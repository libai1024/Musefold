...
export const promptApi = {
  list: (q?: Parameters<import('@musefold/desktop-contracts/ipc').Api['prompt']['list']>[0]) =>
  ...
  update: (id: string, patch: import('@musefold/desktop-contracts/ipc').UpdatePromptPatch) =>
  ...
  incrementUsage: (id: string, action?: 'copy' | 'apply' | 'generate') =>
