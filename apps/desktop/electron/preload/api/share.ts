...
export const shareApi = {
  ...
  buildDeeplink: (req: import('@musefold/desktop-contracts/ipc').ShareBuildDeeplinkRequest) =>
    ipcRenderer.invoke(IPC.SHARE_BUILD_DEEPLINK, req),
  parseDeeplink: (req: import('@musefold/desktop-contracts/ipc').ShareParseDeeplinkRequest) =>
  ...
  onIncoming: (cb: (payload: import('@musefold/desktop-contracts/share').SharePayload) => void) => {
    const listener = (
      _event: unknown,
