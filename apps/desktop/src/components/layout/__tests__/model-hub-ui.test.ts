...
const access = readFileSync('apps/desktop/src/features/settings/sections/AccessModeSection.tsx', 'utf8');
const transitions = readFileSync('apps/desktop/src/features/settings/components/AccessTransitions.tsx', 'utf8');
const doubao = readFileSync('apps/desktop/src/features/settings/sections/DoubaoSection.tsx', 'utf8');
const account = readFileSync('apps/desktop/src/features/settings/sections/AccountSection.tsx', 'utf8');
const providers = readFileSync('apps/desktop/src/features/settings/sections/ProvidersSection.tsx', 'utf8');
const agentConnections = readFileSync('apps/desktop/src/features/settings/sections/AiConnectionsSection.tsx', 'utf8');
