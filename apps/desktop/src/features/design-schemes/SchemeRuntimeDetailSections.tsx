      ...
      {document && (
        <div className="mt-10 space-y-7">
                ...
                <div className="divide-y divide-border-subtle">
                  {document.inputs.map((input) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className={cn('font-medium text-primary', edit.removed && 'line-through')}
                        >
                          {input.kind === 'text' ? `@${input.label}` : input.label}
                        </span>
                        <span className="min-w-0 truncate">
                        ...
                        <span className="flex items-center gap-1.5">
                          {edit.removed ? (
                            ...
                            <>
                              <div
                                className="flex rounded-md bg-inset p-0.5"
                                role="radiogroup"
                              ...
                              <button
                                ...
                                title={
                                  deletable ? '删除这个输入' : '被方案提示词模板引用，不能删除'
                                }
          ...
          <details
            ...
            data-testid="runtime-scheme-tech-details"
          >
