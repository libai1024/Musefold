          ...
          <button
            ...
            onClick={() =>
              useAppStore.getState().requestSchemeCenter({
                detailId: turn.source.kind === 'scheme-run' ? turn.source.schemeId : undefined,
              })
            }
        ...
        {turn.source.kind === 'scheme-creation' && turn.source.githubUrl && (
          ...
          >
            ...
            <span className="min-w-0">
              ...
              <span className="block text-meta text-tertiary">方案来源</span>
            </span>
          </div>
        )}
        {turn.referenceImages.length > 0 && (
          ...
          >
            {turn.references.map((reference, index) => (
              <span
                ...
                title={
                  reference.text.length > 300 ? `${reference.text.slice(0, 300)}…` : reference.text
                }
