...
function createFakeExtras(): DesktopExtras {
  return {
    ...
    getSystemVersion: unusedExtrasMethod('getSystemVersion'),
    listProviders: unusedExtrasMethod('listProviders'),
    createProvider: unusedExtrasMethod('createProvider'),
    updateProvider: unusedExtrasMethod('updateProvider'),
    deleteProvider: unusedExtrasMethod('deleteProvider'),
    saveProviderKey: unusedExtrasMethod('saveProviderKey'),
    hasProviderKey: unusedExtrasMethod('hasProviderKey'),
    setActiveProvider: unusedExtrasMethod('setActiveProvider'),
    validateProvider: unusedExtrasMethod('validateProvider'),
    listProviderModels: unusedExtrasMethod('listProviderModels'),
