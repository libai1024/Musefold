...
import App from './App';
import '@musefold/legacy-ui/tokens.css';
import '@musefold/legacy-ui/theater-fonts.css';
import '@musefold/legacy-ui/brand-fonts.css';
import '@musefold/legacy-ui/primitives.css';
import './styles/globals.css';
import './styles/settings.css';
import '@musefold/product-ui/styles.css';
import './styles/motion.css';
import './styles/overlays-v2.css';
import './styles/workspace-toolbars-v2.css';
