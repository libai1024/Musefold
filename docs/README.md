...
| [v2.1 Web/Desktop 产品一致迁移](v2.1/README.md) | 已批准目标：共享产品能力、host exception、capability v2、Desktop 登录同步硬门禁与 Cloud Agent 只读白名单；基础批次实施中，完整迁移未完成 |
