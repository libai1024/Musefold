...
**当前进度（2026-08-20）**：Phase 0 工程化地基与 Phase 1a 源码目录迁移已完成；Phase 3 共享逻辑归位部分完成（SHARE-06 / 01 / 05 已完成；SHARE-02 / 03 / 04 未开工，SHARE-04 与 Phase 2 stores 切换同批）；Phase 1b（App manifest 下移）与 Phase 2 未开工。
...
| Phase 3 共享逻辑归位 | 纯函数、UI 原语、客户端去重、工作台 store 拆分 | **部分完成（2026-08-20）**：SHARE-06 / 01 / 05 已完成；SHARE-02 / 03 / 04 未开工（可与 Phase 2 交错，不依赖 Phase 1b） |
