...
**当前进度（2026-08-21）**：Phase 0 与 Phase 1 完成；Phase 2 已完成 STATE-01~03 与 ORCH-01~04；SPLIT-01~02 已完成。SPLIT-03 起继续。
...
| Phase 2 状态与编排 | STATE-01~03 + ORCH-01~04：Query 引入与读路径迁移；编排 hook 下沉、`App.tsx` 拆解、桌面切换同一编排层 | **进行中**：STATE-01~03、ORCH-01~03 已完成 |
