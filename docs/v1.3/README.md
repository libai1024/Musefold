...
**当前进度（2026-08-21）**：Phase 0（GOV-01~04）完成；Phase 1（ENT-01~04）完成（history/library 文档化；account 维持 AccountStatus；workbench 已是会话文档；ProviderConfig 迁出 models；渲染层行模型 baseline 归零）。Phase 2 起继续。
