...
export const DESKTOP_MIGRATIONS: MigrationMeta[] = [
  ...
  },
  {
    ...
    bps: true,
    folderMillis: 1788036124346,
    hash: '9a558a2d2cd8c1579929a72f45b3b2316fa8088837a578761e20da02dd2d89ad',
  },
  {
    sql: [
      "ALTER TABLE `cloud_sync_accounts` ADD `consent_state` text DEFAULT 'unset' NOT NULL;",
      'ALTER TABLE `cloud_sync_accounts` ADD `consent_decided_at` integer;',
      'ALTER TABLE `cloud_sync_accounts` ADD `consent_version` integer DEFAULT 1 NOT NULL;',
    ...
    bps: true,
    folderMillis: 1788052052773,
    hash: '9e65eb6cd8e4a3a0a29562384e3b62ab8af98f77c7de9ff496be2e330ddef5fd',
  },
  {
    sql: [
      ...
      'DROP TABLE `cloud_sync_accounts`;',
      'ALTER TABLE `__new_cloud_sync_accounts` RENAME TO `cloud_sync_accounts`;',
      'PRAGMA foreign_keys=ON;',
      'CREATE UNIQUE INDEX `idx_cloud_sync_one_active_account` ON `cloud_sync_accounts` (`active`) WHERE active = 1;',
      'CREATE UNIQUE INDEX `cloud_sync_accounts_owner_id_device_id_unique` ON `cloud_sync_accounts` (`owner_id`,`device_id`);',
    ],
    bps: true,
    folderMillis: 1788056733538,
    hash: '054dbd3b0451baf539857b227a5ec3c2cfb464a6862758f79d235a4beda4ca23',
  },
  {
    sql: [
      ...
      'CREATE UNIQUE INDEX `idx_automation_spend_call_order` ON `automation_spend_calls` (`request_id`,`ordinal`);',
      'CREATE UNIQUE INDEX `idx_automation_spend_call_run` ON `automation_spend_calls` (`generation_run_id`) WHERE generation_run_id IS NOT NULL;',
      'CREATE INDEX `idx_automation_spend_call_state` ON `automation_spend_calls` (`request_id`,`state`);',
      ...
      'CREATE UNIQUE INDEX `idx_automation_spend_idempotency` ON `automation_spend_requests` (`scope_id`,`idempotency_key`) WHERE idempotency_key IS NOT NULL;',
      'CREATE UNIQUE INDEX `idx_automation_spend_confirmation` ON `automation_spend_requests` (`confirmation_id`) WHERE confirmation_id IS NOT NULL;',
      'CREATE UNIQUE INDEX `idx_automation_spend_execution` ON `automation_spend_requests` (`execution_id`);',
      'CREATE INDEX `idx_automation_spend_budget` ON `automation_spend_requests` (`scope_id`,`budget_month`,`reservation_state`);',
      'ALTER TABLE `automation_audit` ADD `automation_request_id` text;',
      'ALTER TABLE `automation_audit` ADD `event_key` text;',
    ...
    bps: true,
    folderMillis: 1788787405979,
    hash: '72bbbb0ced1396b76891fb796b26f74f9a67bae2ef24b35e62ef0c54b96e816a',
  },
  {
    sql: [
    ...
    bps: true,
    folderMillis: 1788839981468,
    hash: '70a4e68357f341f0e0029dac36cd5eb448e23d42ecf038a6c69c57b9b05cd94d',
  },
  {
    sql: [
      ...
      'CREATE UNIQUE INDEX `idx_managed_generation_remote` ON `managed_generation_requests` (`api_issuer`,`principal_id`,`remote_key`);',
      'CREATE UNIQUE INDEX `idx_managed_generation_call` ON `managed_generation_requests` (`call_id`);',
    ],
    bps: true,
    folderMillis: 1788843976853,
    hash: 'b4298758532183ab225b172e8a4d2f3cdb35c756b8e80affdf76e78c54b43fc9',
  },
  {
    sql: ['ALTER TABLE `workbench_sessions` ADD `version` integer DEFAULT 1 NOT NULL;'],
    bps: true,
    folderMillis: 1789280026871,
    hash: 'd171f7f2f82d75595ab632d3880fbd3232679bfe817c44922b6f7330b6a1cb62',
  },
  {
    sql: [
    ...
    bps: true,
    folderMillis: 1789281823432,
    hash: '5904a7ae144f0c407a984c8b939e795f5fd9e5638ba2549ecd31ee9660059aab',
  },
  {
    sql: [
    ...
    bps: true,
    folderMillis: 1789313731113,
    hash: '8a51abc040d79d5902b2c7af258ee429a558b050415f8b2e1674da8dfaecad93',
  },
  {
    sql: [
      ...
      'CREATE UNIQUE INDEX `idx_managed_run_child_job` ON `managed_run_children` (`request_id`,`original_job_id`);',
      'CREATE UNIQUE INDEX `idx_managed_run_child_key` ON `managed_run_children` (`remote_key`);',
      'CREATE UNIQUE INDEX `idx_managed_run_child_call` ON `managed_run_children` (`call_id`) WHERE call_id IS NOT NULL;',
      'CREATE UNIQUE INDEX `idx_managed_run_child_local` ON `managed_run_children` (`local_generation_id`) WHERE local_generation_id IS NOT NULL;',
    ...
    bps: true,
    folderMillis: 1789432954855,
    hash: '2ccfc80f8e1f12bf124ec8988374021fc1f2fd83fddae0df00ba570bfef34e2e',
  },
  {
    sql: [
    ...
    bps: true,
    folderMillis: 1789839138055,
    hash: 'd6f842ba0960617669325043a325ea8909a69f4e38f2e4f76c35562e4d89d538',
  },
];
