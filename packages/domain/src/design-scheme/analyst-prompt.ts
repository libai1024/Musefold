import type { AnalystInput, DesignSchemeRolePrompt } from '@musefold/contracts/design-scheme-model';
...
export function buildAnalystPrompt(input: AnalystInput): DesignSchemeRolePrompt {
  const user = [
  ...
  return { system: ANALYST_SYSTEM, user };
}
