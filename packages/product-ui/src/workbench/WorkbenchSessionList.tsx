import { Archive, LoaderCircle, Pin, PinOff, RefreshCw } from "@musefold/ui/icons";
...
export function WorkbenchSessionList({
  ...
  const errorContent = error ? (
    <div
      className="mf-workbench-session-error"
      role="alert"
      data-testid="workbench-session-error"
    >
  ...
  return (
    <section
      className="mf-workbench-session-list"
      data-testid="workbench-session-list"
    >
      <header>最近对话</header>
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      {editingId === item.id ? (
                        <form
                          className="mf-workbench-session-rename"
