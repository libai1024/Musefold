...
export const Button = forwardRef<HTMLButtonElement, UiButtonProps>(function Button(
  ...
  return (
    ...
    >
      {busy ? <span className="mf-ui-button-spinner" aria-hidden="true" /> : icon}
...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(function IconButton(
  ...
  return (
    <button
      ...
      className={mergeClassNames('mf-ui-icon-button', `mf-ui-icon-button-${size}`, className)}
      aria-label={label}
      title={title ?? label}
    >
      {children}
...
export const Switch = forwardRef<HTMLButtonElement, UiSwitchProps>(function Switch(
