...
const switcher = readFileSync('src/components/layout/SidebarAccessSwitcher.tsx', 'utf8');
const settings = readFileSync('src/features/settings/components/SettingsView.tsx', 'utf8');
const access = readFileSync('src/features/settings/sections/AccessModeSection.tsx', 'utf8');
const transitions = readFileSync('src/features/settings/components/AccessTransitions.tsx', 'utf8');
const doubao = readFileSync('src/features/settings/sections/DoubaoSection.tsx', 'utf8');
