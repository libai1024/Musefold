...
import { MULTI_IMAGE_INDEX_HINT } from '@shared/generation-prompt';

export { MAX_REFERENCE_IMAGES };
export { MULTI_IMAGE_INDEX_HINT, composePromptWithImageIndexHint } from '@shared/generation-prompt';
