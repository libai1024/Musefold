...
const section = readFileSync('src/features/settings/sections/AiConnectionsSection.tsx', 'utf8');
const dialog = readFileSync('src/features/settings/components/AiConnectionDialog.tsx', 'utf8');
